...
<div style="padding:1.25rem;max-width:600px;margin:0 auto;">
    <h1 style="font-size:1.2rem;font-weight:800;margin-bottom:1.25rem;">✏️ Edit Kelompok: {{ $group->name }}</h1>
    <div class="card"><div class="card-body">
        <form action="{{ route('admin.groups.update', $group) }}" method="POST">
            @csrf @method('PUT')
            @foreach(['name'=>'Nama Kelompok','pembina_name'=>'Nama Pembina','pembina_phone'=>'No WA Pembina'] as $field => $label)
